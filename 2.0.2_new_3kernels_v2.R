...
# Function to compute 
c_results = function(n, p1, p2, p3, cor_W, m_A, sd_A, m_B, sd_B){
  ...
  data_mat = gen_3datasets_v2(n, f, p1, p2, p3, cor_W, m_A, sd_A, m_B, sd_B)
...
# Save the results
write.csv(df_all_res, paste0("results_csv/nexp_3k_v2.csv"), 
          row.names=F)